...
contract MerkleDrop is OwnableUpgradeable {
  ...
  function initialize(IERC20 _token, address owner) public initializer {
        __Ownable_init();
        __Context_init_unchained();
        __MerkleDrop_init_unchained(_token, owner);
    }

 
  function __MerkleDrop_init_unchained(IERC20  _token, address owner) internal onlyInitializing {
